...
const Home = (props) => {
  return (
    <div className="mx-2 rounded-5" style={{ height: '90vh', backgroundImage: `url("./bikinh.png")`, backgroundSize: '40%' , backgroundRepeat: 'no-repeat' , backgroundPosition: 'right' , marginTop: '7%'}}>
